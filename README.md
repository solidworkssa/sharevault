# 12-sharevault - Base Native Architecture
...
Sharevault provides a decentralized solution for secure document hashes and access control on both Base (EVM) and Stacks blockchains.
